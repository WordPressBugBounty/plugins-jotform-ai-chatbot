export const ALL_TEXTS = {
  ...
  DISPLAY_AVAILABLE_PRODUCTS: 'Display available products based on customer’s interest or search',
  RECOMMEND_PRODUCTS: 'Recommend Products',
  SUGGEST_PERSONALIZED_PRODUCTS: 'Suggest personalized products that match the customer\'s needs or preferences.',
  ADD_UPDATE_CART: 'Add & Update Cart',
  ADD_PRODUCTS: 'Add products to the customer\'s cart, change item quantities, or update product options.',
  SHOW_ORDER_STATUS: 'Show Order Status',
  SHARE_REAL_TIME_UPDATE: 'Share real-time updates and let customers track their orders.',
  ...
  WOO_COMMERCE_INFO_BOX: 'You can create your Consumer Secret and Key in ',
  WOO_COMMERCE_EMP: 'WooCommerce > Settings > Advanced > REST API.',
